...
int councilRoomCard(int currentPlayer, struct gameState *state, int i, int handPos){
    //+4 Cards
      for (i = 0; i < 4; i++)
        {
          drawCard(currentPlayer, state);
...
int villiageCard(int currentPlayer, struct gameState *state, int handPos) 
    {
      //+1 Card
      drawCard(currentPlayer, state);
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    ...
    case council_room:
    return councilRoomCard(currentPlayer, state, i, handPos);
    ...
    case village:
    return villiageCard(currentPlayer, state, handPos);
    ...
    case embargo: 
    return embargoCard(state, choice1, handPos, currentPlayer);
